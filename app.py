        ...
        if submitted:
            if not id_penyewa or not nama:
                ...
                try:
                    ...
                    conn.commit()
                    conn.close()
                    st.success(f"✅ Penyewa **{nama}** ditambahkan + tagihan **{id_bayar_awal}** dibuat (Rp{total:,} — Belum Lunas)!")
